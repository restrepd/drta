...
% szam=size(amplifier_data);
% data_out=zeros(szam(1)+1,szam(2));
% data_out(1:szam(1),:)=amplifier_data;
% data_out(end,:)=board_adc_data(1,:);
% file_out=[filename(1:end-4) 'out.xlsx'];
% xlswrite(file_out,data_out)


data_out=[];
data_out=amplifier_data(channel_out,:);
file_out=[filename(1:end-4) 'out.xlsx'];
xlswrite(file_out,data_out')
